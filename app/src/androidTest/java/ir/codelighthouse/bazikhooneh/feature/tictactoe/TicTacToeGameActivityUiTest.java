...
public final class TicTacToeGameActivityUiTest {
    ...
    activityRule
        ...
        .onActivity(
            activity -> {
              ...
              assertEquals(
                  activity.getString(R.string.player_won, activity.getString(R.string.mark_x)),
              ...
              assertEquals(
                  activity.getString(R.string.player_turn, activity.getString(R.string.mark_x)),
                  status.getText().toString());
            });
  }
    ...
    activityRule
        ...
        .onActivity(
            activity -> {
              ...
              assertEquals(
                  activity.getString(
                      R.string.player_move_turn, activity.getString(R.string.mark_x)),
                  status.getText().toString());
              ...
              assertEquals(
                  activity.getString(
                      R.string.player_move_turn, activity.getString(R.string.mark_o)),
                  status.getText().toString());
            });
  }
  ...
  public void onlineGameCanResumeBeforeServerStateArrives() {
    ...
    Intent intent =
        new Intent(context, TicTacToeGameActivity.class)
            .putExtra(TicTacToeGameActivity.EXTRA_MODE, "online");
    try (ActivityScenario<TicTacToeGameActivity> scenario = ActivityScenario.launch(intent)) {
      scenario.onActivity(
          activity -> {
