...
public final class AccountFlowUiTest {
  @Test
  public void loginAndRegistrationHaveSeparateFields() {
    ...
    try (ActivityScenario<RegisterActivity> scenario =
      ...
      scenario.onActivity(
          activity -> assertNotNull(activity.findViewById(R.id.register_display_name)));
    }
  }

  @Test
  public void passwordResetStartsAtEmailStepOnly() {
    try (ActivityScenario<PasswordResetActivity> scenario =
        ActivityScenario.launch(PasswordResetActivity.class)) {
      scenario.onActivity(
          activity -> {
            assertEquals(
                View.VISIBLE, activity.findViewById(R.id.reset_request_step).getVisibility());
  ...
  @Test
  public void accessibilityOptionsAreGlobalSettings() {
