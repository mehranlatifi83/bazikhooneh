...
public final class LudoGameTest{
 ...
 @Test public void threeSixesForfeitTurn(){LudoGame game=new LudoGame(2,false);game.roll(6);game.move(0);game.roll(6);game.move(0);assertTrue(game.roll(6).isEmpty());assertEquals(1,game.currentPlayer());}
