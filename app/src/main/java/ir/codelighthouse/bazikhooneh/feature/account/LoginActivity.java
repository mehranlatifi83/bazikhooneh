...
public final class LoginActivity extends NavigableActivity {
  ...
  protected void onCreate(Bundle state) {
    ...
    findViewById(R.id.open_register)
        .setOnClickListener(v -> startActivity(new Intent(this, RegisterActivity.class)));
    findViewById(R.id.forgot_password)
        .setOnClickListener(v -> startActivity(new Intent(this, PasswordResetActivity.class)));
    ((CheckBox) findViewById(R.id.login_show_password))
        ...
        new TextWatcher() {
          ...
          public void onTextChanged(CharSequence s, int a, int b, int c) {
            findViewById(R.id.login_button)
                .setEnabled(
                    username.getText().toString().trim().length() >= 3 && password.length() >= 8);
