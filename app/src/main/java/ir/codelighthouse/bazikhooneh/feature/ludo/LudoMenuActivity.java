...
public final class LudoMenuActivity extends NavigableActivity {
    @Override protected void onCreate(Bundle state) {
        ...
        findViewById(R.id.ludo_bots).setOnClickListener(v ->
                startActivity(gameIntent("bots")));
        findViewById(R.id.ludo_online).setOnClickListener(v ->
                AppNavigator.openRooms(this, "ludo"));
        findViewById(R.id.ludo_guide).setOnClickListener(v ->
                startActivity(new Intent(this, LudoGuideActivity.class)));
    }
    ...
    private void startLocalGame() {
        int selected = ((RadioGroup) findViewById(R.id.ludo_player_count))
