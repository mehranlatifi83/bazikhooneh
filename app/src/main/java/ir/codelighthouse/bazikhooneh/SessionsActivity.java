...
public final class SessionsActivity extends NavigableActivity {
    ...
    private void confirmRevoke(JSONObject session) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.confirm_action, (dialog, which) ->
                        client.delete("revoke_one", "/api/v1/accounts/sessions/"
    ...
    private void render(JSONObject response) {
        ...
        status.setText(getString(R.string.active_sessions_count,
        ...
        for (int index = 0; results != null && index < results.length(); index++) {
            ...
            details.setText(getString(current ? R.string.current_session_device_item
                            : R.string.other_session_device_item,
                    device, version, date(session.optString("created_at")),
