  ...
  private void renderInvites(JSONObject json) {
    ...
    for (int i = 0; values != null && i < values.length(); i++) {
      ...
      b.setOnClickListener(
          v ->
              startActivity(
                  new Intent(this, CommunityRoomsActivity.class)
                      .putExtra(CommunityRoomsActivity.EXTRA_ROOM_CODE, code)
                      .putExtra(
                          CommunityRoomsActivity.EXTRA_GAME_KEY, invite.optString("game_key"))));
          ...
          runOnUiThread(
              () -> {
                if ("friends".equals(op)) renderFriends(json);
                  ...
                  if (room != null)
                    startActivity(
                        new Intent(FriendsActivity.this, CommunityRoomActivity.class)
