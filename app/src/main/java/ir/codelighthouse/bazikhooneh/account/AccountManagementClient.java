...
public final class AccountManagementClient {
  public interface Listener {
    void onSuccess(String operation, JSONObject response);
  ...
  public void get(String operation, String path) {
    request(operation, path, "GET", null);
  }

  public void post(String operation, String path, JSONObject body) {
    request(operation, path, "POST", body);
  }

  public void delete(String operation, String path) {
    request(operation, path, "DELETE", null);
  }

  public void delete(String operation, String path, JSONObject body) {
    request(operation, path, "DELETE", body);
  }
  ...
  private void request(String operation, String path, String method, JSONObject body) {
    ...
    else if ("DELETE".equals(method)) builder.delete(payload);
