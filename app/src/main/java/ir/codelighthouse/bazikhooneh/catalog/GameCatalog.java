  ...
  public static List<GameDefinition> availableGames() {
    return Arrays.asList(
        new GameDefinition(
            ...
            R.string.tic_tac_toe_card,
            R.string.tic_tac_toe_description,
            TicTacToeMenuActivity.class,
            TicTacToeGuideActivity.class,
            null,
            true),
        new GameDefinition(
            "ludo",
            R.string.ludo_card,
            R.string.ludo_description,
            LudoMenuActivity.class,
            LudoGuideActivity.class,
            null,
            true));
  }
