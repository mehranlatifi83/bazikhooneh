...
public final class RoomSharing {
    ...
    public static void share(Activity activity, String title, String roomCode) {
        Intent share = new Intent(Intent.ACTION_SEND)
                ...
                .putExtra(Intent.EXTRA_TEXT, activity.getString(
                        R.string.share_room_text, title, roomCode,
                        RoomLink.canonicalUrl(roomCode)));
        activity.startActivity(Intent.createChooser(
                share, activity.getString(R.string.share_room)));
    }
}
