...
public final class LanguageActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        if (LanguageManager.hasSelection(this)) { openHome(); return; }
    ...
    private void choose(String language) { LanguageManager.select(this, language); openHome(); }
    private void openHome() {
        Intent home = new Intent(this, HomeActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
