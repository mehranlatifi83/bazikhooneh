...
from .community import (
    CommunityCallModerationView,
    CommunityCallView,
    CommunityGameView,
    CommunityGameJoinView,
    CommunityInviteView,
...
urlpatterns = [
    ...
    path(
        "ludo/rooms/<str:code>/start/", StartLudoRoomView.as_view(), name="ludo-start"
    ),
    ...
    path(
        "community/rooms/<str:code>/",
        CommunityRoomView.as_view(),
        name="community-room",
    ),
    path(
        "community/rooms/<str:code>/leave/",
        CommunityLeaveView.as_view(),
        name="community-leave",
    ),
    path(
        "community/rooms/<str:code>/messages/",
        CommunityMessagesView.as_view(),
        name="community-messages",
    ),
    path(
        "community/rooms/<str:code>/invite/",
        CommunityInviteView.as_view(),
        name="community-invite",
    ),
    path(
        "community/rooms/<str:code>/events/",
        CommunityEventsView.as_view(),
        name="community-events",
    ),
    path(
        "community/rooms/<str:code>/messages/<int:message_id>/",
        CommunityMessageView.as_view(),
        name="community-message",
    ),
    path(
        "community/rooms/<str:code>/join-requests/<int:request_id>/",
        CommunityJoinRequestView.as_view(),
        name="community-join-request",
    ),
    path(
        "community/rooms/<str:code>/moderate/",
        CommunityModerationView.as_view(),
        name="community-moderate",
    ),
    path(
        "community/rooms/<str:code>/call/",
        CommunityCallView.as_view(),
        name="community-call",
    ),
    path(
        "community/rooms/<str:code>/call/moderate/",
        CommunityCallModerationView.as_view(),
        name="community-call-moderate",
    ),
    path(
        "community/rooms/<str:code>/game/",
        CommunityGameView.as_view(),
        name="community-game",
    ),
    path(
        "community/rooms/<str:code>/game/join/",
        CommunityGameJoinView.as_view(),
        name="community-game-join",
    ),
