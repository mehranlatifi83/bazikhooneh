...
urlpatterns = [
    ...
    path(
        "session/upgrade/", UpgradeSessionView.as_view(), name="account-session-upgrade"
    ),
    ...
    path(
        "email/request/", EmailVerificationRequestView.as_view(), name="email-request"
    ),
    path(
        "email/confirm/", EmailVerificationConfirmView.as_view(), name="email-confirm"
    ),
    path(
